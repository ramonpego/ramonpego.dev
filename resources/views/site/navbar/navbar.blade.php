    ...
    <div class="collapse navbar-collapse" id="navbar">
        <ul class="navbar-nav ml-auto navbar__menu">
            <li class="nav-item navbar__item">
                <a class="nav-link navbar__link active" aria-current="page" href="#"> Home </a>
            </li>

            <li class="nav-item navbar__item">
                <a class="nav-link navbar__link" href="#"> Posts </a>
            </li>

            <li class="nav-item navbar__item">
                <a class="nav-link navbar__link" href="#"> Contato </a>
            </li>
        </ul>
    </div>
</nav>
